      ...
      <div className="max-w-7xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            <span className="gradient-text">About 3xGrowth</span>
          </h1>
        ...
        >
          <div className="glass-effect p-6 rounded-lg">
            ...
            <p className="text-gray-400">Of B2B marketing expertise</p>
          </div>
          <div className="glass-effect p-6 rounded-lg">
            <Group className="text-purple-400 text-4xl mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2">100+ Companies</h3>
            <p className="text-gray-400">Successfully transformed</p>
          </div>
          <div className="glass-effect p-6 rounded-lg">
            <TrendingUp className="text-green-400 text-4xl mb-4 mx-auto" />
            <h3 className="text-xl font-semibold mb-2">300% ROI</h3>
            <p className="text-gray-400">Average improvement</p>
          </div>
        </motion.div>
      </div>
    </section>
