      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <div className="glass-effect p-6 rounded-lg">
            <Email className="text-blue-400 text-3xl mb-4 mx-auto" />
            <h3 className="text-lg font-semibold mb-2">Email Us</h3>
            <p className="text-gray-400">hello@3xgrowth.in</p>
          </div>
          <div className="glass-effect p-6 rounded-lg">
            <Phone className="text-green-400 text-3xl mb-4 mx-auto" />
            <h3 className="text-lg font-semibold mb-2">Call Us</h3>
            <p className="text-gray-400">+91 XXX XXX XXXX</p>
          </div>
          <div className="glass-effect p-6 rounded-lg">
            <LocationOn className="text-purple-400 text-3xl mb-4 mx-auto" />
