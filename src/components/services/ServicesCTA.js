        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="glass-effect p-6 rounded-lg">
              ...
              <p className="text-lg font-semibold text-white">Free Consultation</p>
              <p className="text-gray-400">30-minute strategy session</p>
            </div>
            <div className="glass-effect p-6 rounded-lg">
              <RocketLaunch className="text-green-400 text-3xl mb-2 mx-auto" />
              <p className="text-lg font-semibold text-white">Quick Results</p>
              <p className="text-gray-400">See impact within 30 days</p>
            </div>
          </div>
        </motion.div>
      </div>
